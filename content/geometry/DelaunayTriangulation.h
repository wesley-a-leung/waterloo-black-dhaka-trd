/**
 * Author: wleung_bvg
 * Description: If all points are collinear, there is no triangulation.
 * If there are 4 or more points on the same circle, the triangulation is ambiguous, otherwise it is unique.
...
vector<DelaunayTriangulation::Quad> DelaunayTriangulation::Quad::V = vector<DelaunayTriangulation::Quad>();
